namespace Schnorrkel.Scalars
{
    ...
    public class Scalar52
    {
        ...
        public static ulong[] GetU64Data(byte[] data)
        {
            ...
            {
                BitConverter.ToUInt64(data.Take(8).ToArray(),0),
                BitConverter.ToUInt64(data.Skip(8).Take(8).ToArray(),0),
                BitConverter.ToUInt64(data.Skip(16).Take(8).ToArray(),0),
                BitConverter.ToUInt64(data.TakeLast(8).ToArray(),0),
                0
            };
